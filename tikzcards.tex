...
\newcommand{\cardcontent}[2]{
  ...
  \node[above right, align=justify, draw, fill=yellow!20, rectangle, minimum height=6ex, minimum width=(\cardwidth-\stripwidth-2*\strippadding-2*\borderwidth)*1cm] (req) at (\borderwidth+2*\strippadding+\stripwidth+0*\textpadding,\textpadding+\borderwidth) {TEST};
}
...
\newcommand{\cardsoc}[2]{
  \fullcard{#1}{red}{Sozialistisch}{#2}
}

\newcommand{\cardlib}[2]{
  \fullcard{#1}{yellow}{Neoliberal}{#2}
}
